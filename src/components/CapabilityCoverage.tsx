        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-0">
          {TECHNOLOGIES.map((tech, idx) => (
            <motion.div
              ...
              className="group relative flex items-baseline gap-4 py-5 border-b border-gray-200 cursor-default"
            >
              <span className="text-sm font-mono text-[#4a5d23]/70 transition-colors duration-300 group-hover:text-[#4a5d23]">
                {String(idx + 1).padStart(2, '0')}
              </span>
              <span className="text-[17px] font-bold text-gray-900 tracking-wide">{tech}</span>
